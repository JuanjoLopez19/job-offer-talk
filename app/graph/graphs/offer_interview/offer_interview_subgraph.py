...
def build_offer_interview_subgraph(builder: StateGraph):
    ...
    builder.add_node(NodeNames.ASK_FOR_NEW_QUESTION_NODE, ask_for_new_question_node)
    hitl_node = partial(
        human_node,
    ...
    hitl_node = partial(
        human_node,
        node_name=NodeNames.ASK_FOR_NEW_QUESTION_HITL_NODE,
        add_to_conversation_history=True,
    )
    builder.add_node(NodeNames.ASK_FOR_NEW_QUESTION_HITL_NODE, hitl_node)
    ...
    builder.add_edge(
        NodeNames.ASK_FOR_NEW_QUESTION_HITL_NODE, NodeNames.ASK_FOR_NEW_QUESTION_NODE
    )

    builder.add_conditional_edges(
        NodeNames.ASK_FOR_NEW_QUESTION_NODE,
